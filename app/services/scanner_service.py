...
VITASCORE_EXPLANATION_I18N: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "adj_whole_food_floor": "The final score was lifted because this product type is typically assessed more positively",
        "adj_whole_food_cap": "The final score was kept more conservative for a more cautious assessment of this product type",
    ...
    "el": {
        ...
        "adj_whole_food_floor": "\u03a4\u03bf \u03c4\u03b5\u03bb\u03b9\u03ba\u03cc \u03c3\u03ba\u03bf\u03c1 \u03b5\u03bd\u03b9\u03c3\u03c7\u03cd\u03b8\u03b7\u03ba\u03b5 \u03b5\u03c0\u03b5\u03b9\u03b4\u03ae \u03b1\u03c5\u03c4\u03cc\u03c2 \u03bf \u03c4\u03cd\u03c0\u03bf\u03c2 \u03c0\u03c1\u03bf\u03ca\u03cc\u03bd\u03c4\u03bf\u03c2 \u03b1\u03be\u03b9\u03bf\u03bb\u03bf\u03b3\u03b5\u03af\u03c4\u03b1\u03b9 \u03c3\u03c5\u03bd\u03ae\u03b8\u03c9\u03c2 \u03c0\u03b9\u03bf \u03b8\u03b5\u03c4\u03b9\u03ba\u03ac",
        "adj_whole_food_cap": "\u03a4\u03bf \u03c4\u03b5\u03bb\u03b9\u03ba\u03cc \u03c3\u03ba\u03bf\u03c1 \u03ba\u03c1\u03b1\u03c4\u03ae\u03b8\u03b7\u03ba\u03b5 \u03c0\u03b9\u03bf \u03c3\u03c5\u03bd\u03c4\u03b7\u03c1\u03b7\u03c4\u03b9\u03ba\u03cc \u03b3\u03b9\u03b1 \u03c0\u03b9\u03bf \u03c0\u03c1\u03bf\u03c3\u03b5\u03ba\u03c4\u03b9\u03ba\u03ae \u03b1\u03be\u03b9\u03bf\u03bb\u03cc\u03b3\u03b7\u03c3\u03b7 \u03b1\u03c5\u03c4\u03bf\u03cd \u03c4\u03bf\u03c5 \u03c4\u03cd\u03c0\u03bf\u03c5 \u03c0\u03c1\u03bf\u03ca\u03cc\u03bd\u03c4\u03bf\u03c2",
    ...
    "de": {
        ...
        "adj_whole_food_floor": "Der Endwert wurde angehoben, weil dieser Produkttyp in der Regel günstiger bewertet wird",
        "adj_whole_food_cap": "Der Endwert wurde für eine vorsichtigere Bewertung dieses Produkttyps etwas konservativer gehalten",
    ...
    "fr": {
        ...
        "adj_whole_food_floor": "Le score final a \u00e9t\u00e9 relev\u00e9, car ce type de produit est g\u00e9n\u00e9ralement \u00e9valu\u00e9 plus positivement",
        "adj_whole_food_cap": "Le score final a \u00e9t\u00e9 maintenu plus prudent pour une \u00e9valuation plus prudente de ce type de produit",
    ...
    *,
    ...
    message_map = {
        ...
        "nutrient_dense_category": {
            "el": "Η κατηγορία αυτού του προϊόντος έχει συνήθως υψηλή θρεπτική αξία.",
            "en": "This product category usually has high nutrient density.",
            "de": "Diese Produktkategorie weist in der Regel eine hohe Nährstoffdichte auf.",
            "fr": "Cette catégorie de produit présente généralement une forte densité nutritionnelle.",
        },
        "no_additives_simple": {
        ...
        "plain_nuts_seed_category": {
            "el": "Οι απλοί ξηροί καρποί και οι σπόροι ανήκουν συνήθως σε κατηγορία με υψηλή θρεπτική αξία.",
            "en": "Plain nuts and seeds usually belong to a high nutrient-density category.",
            "de": "Einfache Nüsse und Samen gehören in der Regel zu einer nährstoffdichten Kategorie.",
            "fr": "Les noix et graines simples appartiennent généralement à une catégorie à forte densité nutritionnelle.",
        },
...
def _whole_food_floor_adjustments(
    ...
    *,
    ...
    message_map = {
        "whole_food_category": {
            "el": "Το προϊόν ανήκει σε μια απλή κατηγορία τροφίμων με σχετικά φυσική σύνθεση",
            "en": "This product belongs to a simple product category with a relatively natural composition",
            "de": "Dieses Produkt gehört zu einer einfachen Produktkategorie mit vergleichsweise natürlicher Zusammensetzung",
            "fr": "Ce produit appartient à une catégorie simple avec une composition relativement naturelle",
        },
        ...
        "simple_category_floor": {
            "el": "Η πολύ απλή σύνθεση αυτής της κατηγορίας λειτούργησε θετικά στην τελική αξιολόγηση",
            "en": "The very simple composition of this category supported the final assessment",
            "de": "Die sehr einfache Zusammensetzung dieser Kategorie wirkte sich positiv auf die Endbewertung aus",
            "fr": "La composition très simple de cette catégorie a soutenu l’évaluation finale",
        },
        "not_processed_snack_floor": {
            "el": "Αυτός ο τύπος προϊόντος δεν αξιολογείται όπως τα επεξεργασμένα σνακ",
            "en": "This product type is not assessed like processed snack foods",
            "de": "Dieser Produkttyp wird nicht wie verarbeitete Snacks bewertet",
            "fr": "Ce type de produit n’est pas évalué comme un snack transformé",
        },
    }
...
def _evaluate_nutrition_photo_rescue(
    ...
    debug["ocr_text_preview"] = text[:500]
    if not text:
...
async def analyze_photo_product(payload: Dict[str, Any], lang: str = "en") -> Dict[str, Any]:
    ...
    if isinstance(extracted, dict) and extracted.get("error"):
        ...
        nutrition_ocr_debug["ocr_text_preview"] = str(rescue_debug.get("ocr_text_preview") or "")
