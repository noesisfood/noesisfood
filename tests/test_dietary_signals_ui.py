...
class DietarySignalsUiTests(unittest.TestCase):
    def test_frontend_contains_compact_dietary_card_and_localized_strings(self) -> None:
        ...
        self.assertIn('dietary_signal_vegan_name: "Vegan"', content)
        self.assertIn('dietary_signal_vegetarian_name: "Χορτοφαγικό"', content)
        self.assertIn('dietary_signal_halal_name: "Χαλάλ"', content)
